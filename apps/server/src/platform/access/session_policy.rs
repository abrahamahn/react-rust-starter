...
pub fn span_seconds(remember: bool) -> i64 { if remember { 30 * DAY } else { DAY / 2 } }
pub fn idle_seconds(span: i64) -> i64 { span.min(7 * DAY) }
#[cfg(test)]
mod tests {
    use super::*;
    #[test] fn default_and_remembered_lifetimes_match_source_policy() {
